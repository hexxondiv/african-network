  ...
  const thirdContent = (
    <div className="second-steps">
      <div className="flexy flexyM mt7">
        {" "}
        <h5 style={{ flexGrow: 1 }}>Enter your email</h5>
        <h5>
      ...
      <div className="col-md-5">
        <h1>Third steps</h1>
        <button onClick={resetContent} className="offset-md-11 steps-btn">
          Previous
        </button>
        <button onClick={thirdContent} className="offset-md-11 steps-btn">
          Next
        </button>
      </div>
    </div>
  );
  const thirdClick = (newContent) => {
    setContent(thirdContent);
  };
