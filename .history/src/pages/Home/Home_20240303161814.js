...
import Welcome from "../../assets/images/welcome-img.wedp";
import "./home.scss";
export const Home = () => {
      ...
      <div className="welcome-div col-md-10 offset-md-1 flexy mt">
        <div className="col-md-6">
          ...
          <p>
            ...
            are welcome to join ANRD. By joining you will be informed of all the
            Association's activities and initiatives, and be eligible to
