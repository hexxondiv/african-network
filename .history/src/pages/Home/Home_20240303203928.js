...
export const Home = () => {
  ...
  return (
    <>
      ...
      <br />
      <div id="container" className="col-md-12 mt">
        <div id="container2" className="col-md-12">
          <div class="box one flexy col-md-12">
            <div className="col-md-4">
              1feeedvdvfdsfsdfsfsdfasefafafeafadfadfadfadfadfadfadfadfadfadfadfadfadfadfadfadfadfadfaadfadfadfadfadfadfadfddffffafafafafafafafaffaeafeadafafa
            </div>
