...
"
      ...
      <div className="col-md-8 offset-md-2 flexy family">
        <div className="col-md-6 mt8">
          <center>
            {" "}
            <h4>FAMILY BUSINESS LEADERS PROGRAM</h4>
            <h5>Investing in your leaders makes good family business sense</h5>
            <p>
              A unique, world-leading, transformational program for leaders
              working within Family Businesses who are committed to developing
              their careers and helping the business thrive.
            ...
            <p>
              ...
              cornerstone of furthering their career within the family business.
            </p>
            <p>
              ...
              drive the organisation, its management, the owners and ultimately
              the family to the next level of success.
            </p>
            <h6>An experience to make a difference</h6>
            <p>
              Through a combination of 3 x 2-day residential workshops, peer
              learning, and work-based projects, this community of learners will
              be challenged and supported to demonstrate their ability to make a
              significant contribution to their family business.
            </p>
            <p>
              At the workshops, you will expand your professional network and be
              lead through thought-provoking sessions on leadership and
        ...
        <div className="col-md-6">
          ...
          <img src={Img2} width="100%" className="mt3" />
        </div>
      </div>
    </>
  );
