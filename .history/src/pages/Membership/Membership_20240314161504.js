...
"
      ...
      <div className="col-md-8 offset-md-2 flexy mt5 membership-body">
        ...
        <div className="col-md-4 padd">
          <center>
            ...
            <p>
              The AFF peer forum program is the only professionally facilitated,
              executive discussion group for family business leaders, executives
              and CEOs in Africa.
            </p>
        ...
        <div className="col-md-4 padd">
          <center>
            ...
            <h4>FAMILY BUSINESS LEADERS</h4>
            <p>
              A unique, world-leading, transformational program for leaders
              working within Family Businesses who are committed to developing
              their careers and helping the business thrive.
            </p>
      ...
      <div className="family  mobile-padding" id="family">
        ...
        <div className="col-md-8 offset-md-2 flexy ">
          <div
            className="col-md-6 mtt no-margin"
          ...
          >
            <center>
              ...
              <h6>Who is it for?</h6>
              <p>
                The program is open to leaders at all levels (both family and
                non-family members) who are working their way up through the
                business.
              </p>
              <h6>Maximise your family business potential</h6>
              <p>
                You have the drive. You have the foundation. Now is the time to
                shine! This 4–month program brings together talented leaders who
                are committed to their own professional development as a
                cornerstone of furthering their career within the family
                business.
              </p>
              <p>
                At the same time, your business will benefit from the additional
                skills, experiences, and tools that you will obtain to further
                drive the organisation, its management, the owners and
                ultimately the family to the next level of success.
              </p>
              <h6>An experience to make a difference</h6>
              <p>
                Through a combination of 3 x 2-day residential workshops, peer
                learning, and work-based projects, this community of learners
                will be challenged and supported to demonstrate their ability to
                make a significant contribution to their family business.
              </p>
              <p>
                At the workshops, you will expand your professional network and
          ...
          <div className="col-md-6 mtt no-margin">
        ...
        <div className="col-md-8 offset-md-2 flexy ">
          <div className="col-md-6 " style={{ paddingRight: "30px" }}>
            <center>
              ...
              <h4>PEER FORUM GROUPS</h4>
              <h5>
                The AFF peer forum program is the only professionally
                facilitated, executive discussion group for family business
                leaders, executives, and CEOs in Africa.
              </h5>
              <p>
                AFF Peer Forum groups are made up of 10 family business leaders,
                meeting 10 times per year. By joining a peer forum group you
                will learn and share experiences on strategic planning,
                governance, human resources, marketing strategies, family
                business succession, conflict resolution, family business
                dynamics and more.
              </p>
              <h6>I am interested in a Forum Group</h6>
              <ul>
                <li>
                  Peer learning about succession planning, business plans, and
                  family integration
                </li>
                <li>
                  Develop growth strategies and share commercial experience
                  across a variety of industries
                </li>
                <li>Work through family business dynamics</li>
                <li>
                  Access to professional facilitators with experience in
                  organisational behaviour, psychology, business leadership,
                  mentoring & family businesses
                </li>
              </ul>
              <h6>How to join:</h6>
              <p>
                To get started, contact us using the button below or call us for
                a confidential discussion on +263773397495. After completing an
