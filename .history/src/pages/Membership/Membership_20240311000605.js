...
"
      ...
      <div className="col-md-8 offset-md-2 flexy family">
        <div className="col-md-6">
          <h5>FAMILY BUSINESS LEADERS PROGRAM</h5>
          <h6>Investing in your leaders makes good family business sense</h6>
          <p>
            A unique, world-leading, transformational program for leaders
            working within Family Businesses who are committed to developing
            their careers and helping the business thrive.
          ...
          <p>
            ...
            shine! This 4–month program brings together talented leaders who are
            committed to their own professional development as a cornerstone of
            furthering their career within the family business.
          </p>
          <p>
            At the same time, your business will benefit from the additional
            skills, experiences, and tools that you will obtain to further drive
            the organisation, its management, the owners and ultimately the
            family to the next level of success.
          </p>
