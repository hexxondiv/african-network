        ...
        <div className="col-md-4">
          <center>
            <div className="aizuI7  ">
              {" "}
           <svg preserveAspectRatio="xMidYMid meet" data-bbox="26 33.811 147.999 132.378" viewBox="26 33.811 147.999 132.378" height="200" width="200" xmlns="http://www.w3.org/2000/svg" data-type="color" role="presentation" aria-hidden="true" aria-label=""><defs><style>#comp-k3vxsoqo svg [data-color="1"] {fill: #2B365A;}</style></defs>
    <g>
