      ...
      <div className="prefooter-div">
        <center>
          <div className="col-md-6">
            ...
            <p>
              African Family Firms was created by African Family Business Owners
              for African Family Business Owners to establish a Voice and a
              space where African Family Businesses gain the tools and support
              they deserve.
            </p>
          </div>
        </center>
